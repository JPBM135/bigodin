...
export class Execution {
  ...
  private constructor(
    ...
    public readonly extraHelpers: Map<string, Helper>,
   ...
   */
  public pushContext(context: object) {
   ...
   */
  public getDataVar(name: string): unknown {
    const top = this.dataFrames[this.dataFrames.length - 1];
    if (!top) {
      return undefined;
    }

    return Object.hasOwn(top, name) ? top[name] : undefined;
  }
   ...
   */
  public get elapsedMillis(): number {
  ...
  public static of(
    ...
    extraHelpers: Map<string, Helper> = new Map(),
