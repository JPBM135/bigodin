...
<CompactPlayground
  template={'Hello, {{capitalize name}}!'}
  context={{ name: 'george' }}
  helpers={{
    capitalize: (s) => (s == null ? s : String(s).charAt(0).toUpperCase() + String(s).slice(1)),
  }}
/>
...
<CompactPlayground
  template={"Hello, {{default name 'stranger'}}!"}
  cases={[
    { label: 'With name', context: { name: 'George' } },
    { label: 'Without name', context: {} },
  ]}
  helpers={{
    default: (...args) => args.find((v) => v != null) ?? '',
  }}
/>
...
<CompactPlayground
  template={"Hello, {{default (capitalize name) 'stranger'}}!"}
  cases={[
    { label: 'With name', context: { name: 'george' } },
    { label: 'Without name', context: {} },
  ]}
