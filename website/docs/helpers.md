...
sidebar_position: 4
# Auto-generated from HELPERS.md; edit the source file in the repo root.
---
Bigodin ships only the **block primitives** wired to template syntax. Anything else (string, math, date, array utilities, comparisons, etc.) was removed in 3.0.0 — register your own with `bigodin.addHelper(name, fn)`. See [/docs/lib](/docs/lib) for the API and [/docs/language](/docs/language) for syntax.
