...
[standalone-line-whitespace.md](/docs/mustache-compat/standalone-line-whitespace)) - when
...
- `/docs/lib`, `/docs/language` - document.
...
sequencing: implement [standalone-line-whitespace.md](/docs/mustache-compat/standalone-line-whitespace)
