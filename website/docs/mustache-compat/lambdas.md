...
- `Interpolation - Alternate Delimiters` (also blocked by [set-delimiters](/docs/mustache-compat/set-delimiters))
- `Interpolation - Multiple Calls`
- `Escaping` (also blocked by [triple/ampersand](/docs/mustache-compat/triple-mustache-and-ampersand))
- `Section`
- `Section - Expansion`
...
- `/docs/language`, `/docs/lib` - document lambda semantics if implemented.
