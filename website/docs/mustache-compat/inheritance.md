...
- `Default`
- `Variable`
- `Triple Mustache` (also in [triple/ampersand](/docs/mustache-compat/triple-mustache-and-ampersand))
- `Sections`
- `Negative Sections`
- `Mustache Injection`
- `Inherit`
...
Prerequisite: [partials.md](/docs/mustache-compat/partials) (parents are essentially
inheritable partials) and ideally [standalone-line-whitespace.md](/docs/mustache-compat/standalone-line-whitespace).
...
`maxPartialDepth` guards from [partials.md](/docs/mustache-compat/partials) cover them.
...
- `/docs/language`, `/docs/lib` - document.
...
note it in [/docs/](/docs/). Inheritance is the strongest
