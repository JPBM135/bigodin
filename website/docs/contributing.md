...
If Bigodin didn't work as expected, please let us know by opening a [bug report](https://github.com/JPBM135/bigodin/issues/new?assignees=&labels=bug&template=bug_report.md&title=).
...
If something wasn't clear from the documentation, or if you have any questions, please open an [issue](https://github.com/JPBM135/bigodin/issues/new), we're happy to help! Showing us what's not clear from the docs makes it easier for new users to get started.

After the issue is reviewed, feel free to open a PR updating the documentation.

## Opening PRs

If you find an [Issue](https://github.com/JPBM135/bigodin/contribute) you'd like to address, please open a PR!
