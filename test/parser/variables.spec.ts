    ...
    describe('variables', () => {
        ...
        describe('assignment', () => {
            ...
            it('should not allow assignment without expression', () => {
                expect(() => parse('{{= $foo}}')).toThrow(/Expected literal, variable, path or parenthesized expression/i);
            });
        ...
        describe('usage', () => {
            ...
            it('should not allow variables blocks', () => {
                ...
                expect(() => parse('{{#x}}{{else $foo}}{{/x}}')).toThrow(/blocks cannot have variable parameters/);
            });
        });
    });
});
